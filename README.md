...
├──────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                              │
│   DATA SOURCES                         PROCESSING LAYER                    STORAGE & VIZ     │
│                                                                                              │
│   ┌──────────────┐                  ┌────────────────────┐                 ┌──────────────┐  │
│   │  Web Apps    │──┐               │                    │                 │              │  │
│   └──────────────┘  │               │    KAFKA CLUSTER   │                 │  ClickHouse  │  │
│   ┌──────────────┐  │   ┌────────┐  │  ┌──────────────┐ │  ┌───────────┐ │              │  │
│   │  Mobile Apps │──┼──▶│  API   │─┼─▶│  analytics-  │─┼─▶│ Ingester  │─┼▶│  Columnar   │  │
│   └──────────────┘  │   │ Server │  │  │  events      │ │  │ Service   │ │ │  Analytics  │  │
│   ┌──────────────┐  │   │ :8080  │  │  └──────────────┘ │  └───────────┘ │ │  Engine     │  │
│   │  IoT Devices │──┘   └───┬────┘  │                    │       │         │ │              │  │
│   └──────────────┘          │       │  ┌──────────────┐ │       │         │ └──────┬───────┘  │
│                             │       │  │  metrics-    │ │       ▼         │        │          │
...
│   │                    REDIS CACHE                           │    │       │   │  /metrics  │  │
│   │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │    │       │   └──────┬─────┘  │
│   │  │ Query Cache  │  │ Session Store│  │ Rate Limiter │  │    │       │          │        │
│   │  │ TTL: 5min    │  │              │  │              │  │    │       │          ▼        │
│   │  └──────┬───────┘  └──────────────┘  └──────────────┘  │    │       │   ┌────────────┐  │
│   │         │                                               │    │       │   │   Alerts   │  │
│   └─────────┼───────────────────────────────────────────────┘    │       │   │  Manager   │  │
...
│   │                              DATA FLOW                                                │  │
│   │                                                                                       │  │
│   │   Producers ──▶ Kafka Topics ──▶ Ingester ──▶ ClickHouse ──▶ API Queries ──▶ Clients  │  │
│   │        │              │              │                                              │  │
│   │        │              │              └──▶ Worker ──▶ Kafka (reprocess)               │  │
│   │        │              │                                                               │  │
